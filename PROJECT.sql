...
--average sales performance of the product and the previous years's sales
...
/*Group customers into three segments based on their spending behavior:
 VIP:Customer with atleast 12 months of history and spending more than 5000 or less
...
Highlights:
       1. Gather essentials fields such as names,ages, and transactional details.
	   2. Segments customers into categories(VIP,Regular,New) and age groups.
	   3. Aggregatew customer-level metrics:
	      -total orders
		  -total sales
